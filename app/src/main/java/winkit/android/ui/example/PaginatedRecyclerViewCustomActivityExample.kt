...
class PaginatedRecyclerViewCustomActivityExample: AppCompatActivity() {
    private val adapter = CustomLayoutAdapter()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.paginatedrecyclerview_activity_example)
        title = "PaginatedRecyclerView with custom layout"
